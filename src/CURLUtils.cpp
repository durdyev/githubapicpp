...
std::string githubapicpp::CURLUtils::getUser(std::string &clientId, std::string &secret, std::string &user) {
...
std::string githubapicpp::CURLUtils::getUsers(std::string &clientId, std::string &secret, int since) {
    std::ostringstream oss;
...
std::string githubapicpp::CURLUtils::getOrganization(std::string &clientId, std::string &secret, std::string &orgName) {
    std::ostringstream oss;
    oss << GITHUB_API_URL << "/orgs/" << orgName
        << "?client_id=" << clientId << "&client_secret=" << secret;
    return getResponse((char *) oss.str().c_str());
}
